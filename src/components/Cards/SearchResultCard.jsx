    ...
    return(
        <div className={"flex gap-[9vw] relative hover:cursor-pointer group h-fit"}>
            ...
            <div className={"flex flex-col gap-3 md:gap-[24px] w-[50vw] h-full justify-center"}>
                <p className={"text-[8px] font-sans tracking-wide md:text-[16px] truncate"}>{city}, {country}</p>
                <h2 className={"text-[12px] sm:text-[20px] font-bold font-sans tracking-wide md:text-[36px] truncate"}>{name}</h2>
                <p className={"text-[8px] sm:text-[16px] font-semibold font-sans tracking-wide md:text-[26px] truncate"}>{price}kr Per Night</p>
            </div>
                <div>
