...
export function VenueCard ({title, image, rating, city, country, wifi, parking, breakfast, pets, price}){
    return(
        <div className={"w-[310px] overflow-clip relative flex flex-col gap-3 hover:cursor-pointer group"}>
            <div className={"w-[310px] h-[216px] rounded-[20px] overflow-hidden"}>
                <img src={image || "https://bokstartfredrikstad.no/wp-content/themes/vio/assets/images/no-image/No-Image-Found-400x264.png"} alt="venue image"
                     className={"min-w-[310px] min-h-[216px] object-cover transition-transform duration-300 group-hover:scale-105"}
                />
            </div>
